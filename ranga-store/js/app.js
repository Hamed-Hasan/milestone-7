...
const showProducts = (products) => {
  const showProduct = document.getElementById("all-products")
  ...
  for (const product of products) {
    ...
    <img class="product-image" src=${product.image}></img>
      ...
      <button onclick="showDetail(${product.image}')" id="details-btn" class="btn btn-danger">Details</button></div>
      `;
...
const showDetail = (products) => {
  const div = document.createElement('div')
  div.innerHTML = `
  <div><img class="product-image" src=${products}></img></div>
  `
